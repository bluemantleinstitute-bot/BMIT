        ...
        headers: [
          {
            ...
            value: [
              ...
              `img-src 'self' data: blob: ${apiOrigin} https://*.zoom.us https://*.cloud.zoom.us https://*.zoomcdn.com https://*.cloudfront.net https://zoom.us https://i.ytimg.com https://img.youtube.com https://cdn.plyr.io`,
              "media-src 'self' blob: https://*.zoom.us https://*.cloud.zoom.us https://*.zoomcdn.com https://*.cloudfront.net https://www.youtube.com",
              `connect-src 'self' https://*.zoom.us https://*.cloud.zoom.us https://*.zoomcdn.com https://*.cloudfront.net https://zoom.us wss://*.zoom.us wss://*.cloud.zoom.us ${apiOrigin} https://cdn.plyr.io`,
